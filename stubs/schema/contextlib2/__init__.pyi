...
from typing import Any, AsyncContextManager, AsyncIterator, Awaitable, Callable, ContextManager, IO, Iterator, Optional, Type, TypeVar, overload
...
class ExitStack(ContextManager[ExitStack]):
    ...
    def __exit__(self, __exc_type: Optional[Type[BaseException]], __exc_value: Optional[BaseException], __traceback: Optional[TracebackType]) -> bool:
        ...
...
if True:
    ...
    class AsyncExitStack(AsyncContextManager[AsyncExitStack]):
        ...
        def __aexit__(self, __exc_type: Optional[Type[BaseException]], __exc_value: Optional[BaseException], __traceback: Optional[TracebackType]) -> Awaitable[bool]:
            ...
